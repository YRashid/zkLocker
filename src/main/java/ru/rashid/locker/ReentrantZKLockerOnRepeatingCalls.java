 ...
 * Блокировка не между потоками, а между экземплярами класса ReentrantZKLockerOnRepeatingCalls.
 ...
 */
@Slf4j
public class ReentrantZKLockerOnRepeatingCalls implements ReentrantZKLocker {
    ...
    public ReentrantZKLockerOnRepeatingCalls(CuratorFramework curatorFramework, String lockNodeName) {
